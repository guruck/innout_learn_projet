...
class WorkingHours extends Model{
  protected static $tableName = '`innout`.`working_hours`';
  ...
  public static function getMonthlyReport($userId, $date){
    $regs = [];
    $start = getFirstDayOfMonth($date)->format('Y-m-d');
    $ends = getLastDayOfMonth($date)->format('Y-m-d');
  ...
  private function getTimes(){
    ...
    $this->time1 ? array_push($times,stringToDate($this->time1)) : array_push($times,null);
    $this->time2 ? array_push($times,stringToDate($this->time2)) : array_push($times,null);
    $this->time3 ? array_push($times,stringToDate($this->time3)) : array_push($times,null);
    $this->time4 ? array_push($times,stringToDate($this->time4)) : array_push($times,null);
